        ...
        <div className="relative">
          ...
          <div className="relative z-10">
            ...
            <p className="text-text-secondary text-lg mb-8 max-w-xl mx-auto">
              Вступай в закрытый Telegram-канал. Первым узнавай о запуске,
              получи ранний доступ и founding-цену навсегда.
            </p>
            ...
            <p className="text-sm text-text-muted mt-6">
              Уже <span className="text-text-secondary font-semibold">47</span> SMM-специалистов ждут запуска
            </p>
          </div>
        </div>
      </div>
