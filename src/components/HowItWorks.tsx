const steps = [
  {
    ...
    desc: 'Telegram, VK, LinkedIn, Instagram, Threads — все платформы в одном месте.',
    icon: (
  ...
  {
    num: '02',
    title: 'Описываете бренд',
    desc: 'Один раз — стиль, тон, целевая аудитория. Агент запоминает навсегда.',
    icon: (
  ...
  },
  {
    ...
    desc: 'Генерирует контент, адаптирует под каждую платформу, публикует по расписанию.',
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-cyan">
  ...
  {
    num: '04',
    title: 'Вы видите результаты',
    desc: 'Дашборд с аналитикой. Корректируете стратегию — агент адаптируется.',
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-accent-light">
    ...
    <section id="how-it-works" className="section-padding bg-navy-light/50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-14">
          ...
          <p className="text-text-secondary text-lg">Четыре шага от хаоса к автоматизации</p>
        </div>
